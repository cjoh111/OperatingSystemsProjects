...
public class ArrayClient {
	...
	public static void main(String[] args) {
		System.out.println("AC0350: Array Manager - Cole Johnson");
		...
		while (in.hasNext()) {
			...
			try {
				...
				case "W": // COW
					arrayNum = in.nextInt();
					System.out.printf("Creating array-%d as a COW copy to array-%d\n", nextArray, arrayNum);
					arrays[nextArray] = mgr.copyArray(arrays[arrayNum]);
					nextArray++;
					break;
				*/
					case "R":
				...
				System.out.println("*** Null Pointer Exception: Attempted to use a non-existent Array");
			}
		}
		in.close();
	}
